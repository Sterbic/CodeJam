...
while the solution is printed to `stdout`. Practice input files are
present in each problem subfolder and the corresponding output can be
checked against the Code Jam Judge.
